package AdventOfCode.Jul2022.Day7

import java.io.File

var path = mutableListOf("/")
val directorySize = mutableMapOf("/" to 0)
val currentDirectoryContent = mutableListOf<String>()

fun main() {
    val input = File("src/AdventOfCode/Jul2022/Day7/Input").readLines()
