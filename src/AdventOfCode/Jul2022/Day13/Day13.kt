...
fun compare(string1: String, string2: String): Boolean {
    return when {
        ...
        getNum(string1) == getNum(string2) && getNum(string1) != null -> compare(string1.substringAfter(getNum(string1).toString()), string2.substringAfter(getNum(string2).toString()))
