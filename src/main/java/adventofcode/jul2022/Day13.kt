...
fun compare(
    ...
    when {
        ...
        getNum(string1) == getNum(string2) && getNum(string1) != null ->
            compare(
                string1.substringAfter(getNum(string1).toString()),
                string2.substringAfter(
...
fun addBracket(string: String): String = "[${getNum(string)}]${string.drop(getNum(string).toString().length)}"
